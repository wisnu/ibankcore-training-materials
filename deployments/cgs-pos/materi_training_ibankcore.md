...
- Arsitektur modul IBANKCORE yang diimplementasikan pada sistem ini (Funding, Accounting, Kas & Vault, Internal Account, Customer, Enterprise).
...
- Interaksi dengan sistem sekitar: event streaming (Kafka) serta pelaporan regulator (OJK/BI).
...
![Gambar 5.1 — Integrasi Kas & Vault & Treasury dengan sistem sekitar](diagrams/03_integrasi_sistem_sekitar.png)
...
## 7.2 Pelaporan Regulator & Audit Eksternal
...
## 7.5 Integrasi Akuntansi Eksternal (SAP)
...
- Interaksi dengan sistem sekitar (Kafka, QRIS, host-to-host/REST API, regulator) menjadi bagian penting dari arsitektur end-to-end.
